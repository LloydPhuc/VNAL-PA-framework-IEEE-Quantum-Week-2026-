...
def resolve():
    ...
    if os.path.isdir("/kaggle/input"):
        ...
        hits = glob.glob("/kaggle/input/**/wavelengths_260.npy", recursive=True)
        WL = hits[0] if hits else "/kaggle/input/wavelengths_260.npy"
    else:
        ROOT = os.path.join(base, "FULL_PIPELINE", "CABBAGE")
        WL = os.path.join(base, "INPUT", "RAW DATA", "wavelengths_260.npy")
    return ROOT, WL
