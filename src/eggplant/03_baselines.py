...
LOCAL_PATHS = {
    "reflectance": r"D:\HYPERSPECTRAL 1\INPUT\RAW DATA\reflectance_260bands-003.npy",
    "labels":      r"D:\HYPERSPECTRAL 1\INPUT\RAW DATA\Eggplant_Labels.npy",
    "wavelengths": r"D:\HYPERSPECTRAL 1\INPUT\RAW DATA\wavelengths_260bands.npy",
}
PATHS = {k: _kfind(v) for k, v in LOCAL_PATHS.items()}

OUTPUT_DIR = "/kaggle/working/FULL_PIPELINE/results"
if not os.path.isdir("/kaggle/input"):
    OUTPUT_DIR = r"D:\HYPERSPECTRAL 1\FULL_PIPELINE\results"
...
CFG = {
    ...
    "methods": ["Top-MI", "mRMR", "DPP-greedy", "Cluster-Exemplar", "Random"],
